...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo(){
        ...
        for (Organization.Type type : Organization.Type.values()){
            if (type.getValue().equals(Organization.Type.CallCenter.getValue()) || type.getValue().equals(Organization.Type.Fire.getValue()) 
                    || type.getValue().equals(Organization.Type.Citizen.getValue())|| type.getValue().equals(Organization.Type.Police.getValue())
                    || type.getValue().equals(Organization.Type.Ambulance.getValue()))
